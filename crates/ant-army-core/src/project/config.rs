...
pub struct ProjectConfig {
    ...
    /// Last time ant-army ran in this project
...
impl ProjectConfig {
    ...
    pub fn new(path: impl Into<PathBuf>) -> Self {
        ...
        Self {
            ...
            path,
            db_name: format!("ant_army_{}", project_id),
    ...
    pub fn database_url(&self, password: &str) -> String {
        format!(
            "postgresql://ant_army:{}@localhost:5432/{}",
...
mod tests {
    ...
    fn test_database_name() {
        ...
        assert!(config.db_name.starts_with("ant_army_"));
    }
