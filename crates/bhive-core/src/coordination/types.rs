...
#[sqlx(type_name = "operator_type", rename_all = "lowercase")]
...
/// Operator status in the worker pool
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, Type)]
#[sqlx(type_name = "operator_status", rename_all = "lowercase")]
...
pub struct Operator {
    pub id: Uuid,
    /// Project this operator belongs to (operators are project-scoped)
...
pub struct CoordinationStats {
    ...
    pub idle_operators: i64,
    pub active_operators: i64,
    pub failed_operators: i64,
